    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preparation_start', models.DateTimeField(null=True, verbose_name='Start of preparations')),
                ('time', models.DateTimeField(verbose_name='Time and date for start of concert')),
                ('time_end', models.DateTimeField(null=True, verbose_name='Time for the expected end')),
                ('takedown_end', models.DateTimeField(null=True, verbose_name='End of takedown (ie. the stage is free)')),
